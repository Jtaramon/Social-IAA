...
# Función para dibujar la vista de pájaro para la región de interés (ROI). Los puntos rojos, amarillos y verdes representan un riesgo para los humanos.
# Rojo: alto riesgo
...
# Función para dibujar cuadros delimitadores según el factor de riesgo para humanos en un marco y trazar líneas entre
# recuadros según factor de riesgo entre dos humanos.
# Rojo: alto riesgo
# Amarillo: Riesgo bajo
# Verde: sin riesgo
def social_distancing_view(frame, distances_mat, boxes, risk_count):
    ...
    cv2.putText(pad, "s", (50, 30),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (100, 100, 0), 2)
    cv2.putText(pad, "-- Riesgo Alto: " + str(risk_count[0]) + " people", (50, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 1)
    cv2.putText(pad, "-- Riesgo Medio: " + str(risk_count[1]) + " people", (50, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 255), 1)
    cv2.putText(pad, "-- Sin Riesgo" + str(risk_count[2]) + " people", (50,  100), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 1)
