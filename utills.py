...
# Función para calcular el centro inferior para todos los cuadros delimitadores y transformar la perspectiva para todos los puntos.
...
# La función calcula la distancia entre dos puntos (humanos). distancia_w, distancia_h representa el número
# de píxeles en 180 cm de longitud horizontal y verticalmente. Calculamos horizontal y vertical
# distancia en píxeles para dos puntos y obtener la relación en términos de una distancia de 180 cm usando distance_w, distance_h.
# Luego calculamos cuánta distancia en cm hay horizontal y verticalmente y luego usamos pitágoras
# Calculamos la distancia entre puntos en cm.
...
# La función calcula la distancia entre todos los pares y calcula la relación de proximidad.
...
# La función proporciona escala para la vista de pájaro
def get_scale(W, H):
...
# La función cuenta para los seres humanos con alto riesgo, bajo riesgo y sin riesgo
